  ...
  return (
    <main className="min-h-screen bg-[#f0f4f8] px-4 pb-20 pt-32">
      <div className="mx-auto max-w-lg rounded-3xl bg-white p-8 text-center shadow-sm sm:p-12">
        ...
        {status === "success" ? (
          <><h1 className="mt-4 font-display text-3xl font-black text-[#0a1a2f]">You’re unsubscribed</h1><p className="mt-4 leading-relaxed text-[#4a6580]">We will no longer send ministry updates to this contact. Contact the ministry if you would like to receive them again.</p></>
